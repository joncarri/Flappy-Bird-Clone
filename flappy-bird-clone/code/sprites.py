...
class BG(pygame.sprite.Sprite):
    def __init__(self,groups,scale_factor):
        ...
        full_sizeed_image = pygame.transform.scale(bg_image, (full_width,full_height))

        #Two background images for animation
        self.image =pygame.Surface((full_width * 2, full_height))
        self.image.blit(full_sizeed_image, (0, 0))
        self.image.blit(full_sizeed_image, (full_width, 0))
